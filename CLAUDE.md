...
## Active Technologies
- Node.js 18+ (for Docusaurus), JavaScript/TypeScript for configuration + Docusaurus 3.x, React, Markdown/MDX processors, Node.js package ecosystem (001-ros2-fundamentals)
- Static file system for documentation content, Git for version control (001-ros2-fundamentals)
- JavaScript/TypeScript for Docusaurus configuration, Markdown/MDX for content + Docusaurus 3.x, React, Node.js 18+, ROS 2 ecosystem, Gazebo simulation environment, Unity 3D (002-digital-twin-simulation)
